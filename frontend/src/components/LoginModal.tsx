...
export default function LoginModal({ isOpen, onClose }: LoginModalProps) {
  ...
  // Direct call to Firebase - no async wrapper to avoid popup blocking
  const handleSignIn = () => {
    setIsSigningIn(true);
    setError(null);
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-gray-500 text-center mt-6">
          En vous connectant, vous acceptez que vos votes soient utilisés pour améliorer les recommandations de la communauté.
        </p>
      </div>
    </div>
  );
